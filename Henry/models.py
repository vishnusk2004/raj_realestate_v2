...
class OpenHouse(models.Model):
    ...
    contact_email = models.EmailField(help_text="Contact email for inquiries", default="contact@henryoakreality.com")
    contact_phone = models.CharField(max_length=20, help_text="Contact phone number", default="+1 (234) 567-890")
