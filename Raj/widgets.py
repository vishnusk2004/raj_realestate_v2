...
class RichTextWidget(forms.Textarea):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        help_text = """
        <div style="margin-top: 10px; padding: 10px; background-color: #2d3748; border: 1px solid #4a5568; border-radius: 4px;">
            <h4 style="margin: 0 0 10px 0; color: #e2e8f0;">HTML Formatting Guide:</h4>
            <div style="font-size: 12px; line-height: 1.4; color: #cbd5e0;">
