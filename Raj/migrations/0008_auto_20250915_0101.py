...
def update_contact_info(apps, schema_editor):
    ...
    PropertyListing = apps.get_model('Raj', 'PropertyListing')
    OpenHouse = apps.get_model('Raj', 'OpenHouse')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Raj', '0007_sellingcontact_ip_address_sellingcontact_language_and_more'),
    ]
